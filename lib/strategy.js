...
function OAuth2Strategy(options, verify) {
  ...
  this._oauth2._useAuthorizationHeaderForGET = !!options.useAuthorizationHeaderForGET;
  this._oauth2._useAuthorizationHeaderForPOST = !!options.useAuthorizationHeaderForPOST;
